...
/// Builds a data class for the given selection set
///
/// [fragmentSelSets] provides a map of fragment class names along with their
/// selection sets which correspond to the given [selSet] for this node. This
/// allows us have the data class recursively implement the fragment class.
